const countryData = [
	...
	{ Note: '', Country: 'Angola', ISO: 'AO', Format: '- no codes -', Regex: '' },
	{
	...
	{ Note: '', Country: 'Aruba', ISO: 'AW', Format: '- no codes -', Regex: '' },
	{
	...
	{ Note: '', Country: 'Belize', ISO: 'BZ', Format: '- no codes -', Regex: '' },
	{ Note: '', Country: 'Benin', ISO: 'BJ', Format: '- no codes -', Regex: '' },
	{
	...
	{ Note: '', Country: 'Chad', ISO: 'TD', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
	...
	{ Note: '', Country: 'Egypt', ISO: 'EG', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
		Note: '',
	...
	{ Note: '', Country: 'Fiji', ISO: 'FJ', Format: '- no codes -', Regex: '' },
	{
	...
	{ Note: '', Country: 'Gambia', ISO: 'GM', Format: '- no codes -', Regex: '' },
	{
		Note: '',
		Country: 'Georgia',
		ISO: 'GE',
	...
	{ Note: '', Country: 'Guinea', ISO: 'GN', Format: '- no codes -', Regex: '' },
	{
		Note: '',
	...
	{ Note: '', Country: 'Guyana', ISO: 'GY', Format: '- no codes -', Regex: '' },
	{ Note: '', Country: 'Haiti', ISO: 'HT', Format: 'NNNN', Regex: '^\\d{4}$' },
	{
	...
	{ Note: '', Country: 'Iceland', ISO: 'IS', Format: 'NNN', Regex: '^\\d{3}$' },
	{
	...
	{ Note: '', Country: 'Iraq', ISO: 'IQ', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
	...
	{ Note: '', Country: 'Laos', ISO: 'LA', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
	...
	{ Note: '', Country: 'Lesotho', ISO: 'LS', Format: 'NNN', Regex: '^\\d{3}$' },
	{
	...
	{ Note: '', Country: 'Libya', ISO: 'LY', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
	...
	{ Note: '', Country: 'Malawi', ISO: 'MW', Format: '- no codes -', Regex: '' },
	{
		Note: '',
		Country: 'Maldives',
		ISO: 'MV',
	...
	{ Note: '', Country: 'Mali', ISO: 'ML', Format: '- no codes -', Regex: '' },
	{
		Note: 'Kodiċi Postali',
		Country: 'Malta',
		ISO: 'MT',
	...
	{ Note: '', Country: 'Nauru', ISO: 'NR', Format: '- no codes -', Regex: '' },
	{ Note: '', Country: 'Nepal', ISO: 'NP', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
	...
	{ Note: '', Country: 'Niger', ISO: 'NE', Format: 'NNNN', Regex: '^\\d{4}$' },
	{
		Note: '',
		Country: 'Nigeria',
		ISO: 'NG',
	...
	{ Note: '', Country: 'Niue', ISO: 'NU', Format: '- no codes -', Regex: '' },
	{
		Note: 'Part of the Australian postal code system.',
	...
	{ Note: '', Country: 'Peru', ISO: 'PE', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
		Note: '',
		Country: 'Philippines',
		ISO: 'PH',
	...
	{ Note: '', Country: 'Qatar', ISO: 'QA', Format: '- no codes -', Regex: '' },
	{
	...
	{ Note: '', Country: 'Sudan', ISO: 'SD', Format: 'NNNNN', Regex: '^\\d{5}$' },
	{
		Note: '',
		Country: 'Suriname',
		ISO: 'SR',
	...
	{ Note: '', Country: 'Togo', ISO: 'TG', Format: '- no codes -', Regex: '' },
	{
		Note: '',
		Country: 'Tokelau',
		ISO: 'TK',
	...
	{ Note: '', Country: 'Tonga', ISO: 'TO', Format: '- no codes -', Regex: '' },
	{
	...
	{ Note: '', Country: 'Tuvalu', ISO: 'TV', Format: '- no codes -', Regex: '' },
	{ Note: '', Country: 'Uganda', ISO: 'UG', Format: '- no codes -', Regex: '' },
	{
		Note: '',
		Country: 'Ukraine',
		ISO: 'UA',
